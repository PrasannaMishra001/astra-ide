...
export const RESEARCH: ResearchItem[] = [
  {
    ...
    result: 'real trace',
    resultSub: 'CP-PPO lowers makespan 5.8% against HEFT at 15 tasks; ties at 40',
    method: 'CP-PPO (critical-path-guided PPO scoring every task-VM pair, distilled from rollout search)',
