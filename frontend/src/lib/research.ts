...
export const RESEARCH: ResearchItem[] = [
  {
    ...
    result: 'vs 4 baselines',
    resultSub: 'beats round-robin, random, FIFO, least-loaded on the weighted objective',
    ...
    paperVenue: 'Deep RL for cloud workflow scheduling',
  ...
  },
  {
    ...
    result: 'F1 0.83',
    resultSub: 'on LID-DS CVE traces, above STIDE (0.75) and frequency baselines (0.74)',
